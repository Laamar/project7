...
public class Driver 
{
    ...
    {
        //declare a constant for the number of elements in the list and set it 
        //equal to 1000
        final int NUM_ELEMENTS = 1000;
        //Declare and instanite an ArrayList for objects of your class
       ...
       //print out the time it takes to get the all the elements from the list randomly
        ...
        // Use a loop to add the specified number of randomly generated objects
        // to the list
        for (int i = 0; i < NUM_ELEMENTS; i++) {
